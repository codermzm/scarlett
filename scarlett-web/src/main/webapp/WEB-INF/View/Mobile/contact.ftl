...
<html>
	<head>
		...
		<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script><!--/*地图密钥*/-->
	</head>
	<body>
		...
		<section>
			...
			<div class="map-wrap">
				...
				<span class="map-notewrap font24 fontwhite">
					<p class="map-note">山东省临沂市经济开发区沃尔沃路55号中印软件产业园</p>
				</span>
			</div>
			<div class="contact-wrap">
				<p class="contact-item font30">联系方式</p>
				<p class="contact-item font30">电话：0539-8800978</p>
				<p class="contact-item font30">Q Q：2254898878</p>
				<p class="contact-item font30">微信：sdlwkj</p>
				<p class="contact-item font30">地址：临沂市经开区中印软件产业园（临沂云计算中心）</p>
			</div>
		</section>
...
<script>
    ...
    function createMap(){
        ...
        var point = new BMap.Point(118.438692,35.015248);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"山东临网网络",content:"我的备注",point:"118.438652|35.014716",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
