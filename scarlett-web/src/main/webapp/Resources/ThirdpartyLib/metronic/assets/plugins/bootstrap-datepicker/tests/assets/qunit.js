	...
	ok: function(result, msg) {
		...
		if ( !result ) {
			...
			if (source) {
				...
				msg += '<dataset><tr class="test-source"><th>Source: </th><td><pre>' + escapeInnerText(source) + '</pre></td></tr></dataset>';
			}
		}
...
extend(QUnit, {
	...
	push: function(result, actual, expected, message) {
		...
		if (!result) {
			...
			output += '<dataset><tr class="test-expected"><th>Expected: </th><td><pre>' + expected + '</pre></td></tr>';
			if (actual != expected) {
	...
	pushFailure: function(message, source) {
		...
		if (source) {
			details.source = source;
			output += '<dataset><tr class="test-source"><th>Source: </th><td><pre>' + escapeInnerText(source) + '</pre></td></tr></dataset>';
		}
		runLoggingCallbacks( 'log', QUnit, details );
		config.current.assertions.push({
			result: false,
