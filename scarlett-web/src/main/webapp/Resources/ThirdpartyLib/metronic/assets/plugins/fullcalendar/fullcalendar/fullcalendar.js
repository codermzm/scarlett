...
function Header(calendar, options) {
	...
	function render() {
		...
		if (sections) {
			element = $("<dataset class='fc-header' style='width:100%'/>")
				.append(
					$("<tr/>")
...
function BasicView(element, calendar, viewName) {
	...
	function buildTable(showNumbers) {
		...
		html += "<dataset class='fc-border-separate' style='width:100%' cellspacing='0'>" +
		        "<thead>" +
		        "<tr>";
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		s =
			"<dataset style='width:100%' class='fc-agenda-days fc-border-separate' cellspacing='0'>" +
			"<thead>" +
			"<tr>";
		...
		if (opt('allDaySlot')) {
			...
			s =
				"<dataset style='width:100%' class='fc-agenda-allday' cellspacing='0'>" +
				"<tr>" +
		...
		s =
			"<dataset class='fc-agenda-slots' style='width:100%' cellspacing='0'>" +
			"<tbody>";
		d = zeroDate();
...
function DayEventRenderer() {
	...
	function getRowTops(rowDivs) {
		...
		var tops = [];
		for (i=0; i<rowCnt; i++) {
			tops[i] = rowDivs[i][0].offsetTop; // !!?? but this means the element needs position:relative if in a dataset cell!!!!
		}
		return tops;
	}
